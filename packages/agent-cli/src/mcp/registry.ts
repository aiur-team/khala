...
export const MCP_TOOLS: readonly McpTool[] = Object.freeze([sendTool, readTool, listeningModeTool, listChannelsTool, listAgentsTool, requestChannelAccessTool, channelAccessStatusTool]);

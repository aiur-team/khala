...
// another room. A lease keeps concurrent callers (another click, another tab) from
...
type CreateResult = OperationResult<RoomSummary, RoomRejection>;

export async function createRoom(ctx: RoomContext, input: CreateInput, options?: CallOptions): Promise<CreateResult> {
...
async function reconcile(
  ctx: RoomContext, operationId: string, found: CreateRecord, revision: string, options: CallOptions | undefined,

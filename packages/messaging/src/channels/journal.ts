// Local channel-operation journal. Intent is written here before any remote effect so a
...
import type { DeviceId, EventRef, MessageContent, OwnerId, ParticipantId, RoomId, ChannelSummary, SendState } from '@khala/contracts/messaging/index';
...
export interface ChannelJournal {
...
/** @deprecated Use `ChannelJournal`. Kept through the first tagged release containing #163. */
export type RoomJournal = ChannelJournal;
 ...
 */
export function createMemoryChannelJournal(): ChannelJournal {
...
/** @deprecated Use `createMemoryChannelJournal`. Kept through the first tagged release containing #163. */
export const createMemoryRoomJournal = createMemoryChannelJournal;

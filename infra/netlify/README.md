...
- It does not implement `apps/control/src/composition/human/handlers.ts` or
  `.../agent/handlers.ts` (KHA-132/133 own those) or a production web build
  entry (also KHA-132).
- It does not finalize SDK-specific CSP (follows KHA-141/143 evidence).

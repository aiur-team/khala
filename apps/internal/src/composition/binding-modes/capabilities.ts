...
// Codex claim is unknown. OpenCode is claimed from the version its installed plugin
// reports: proven only for an exact version with retained route evidence,
// experimental for any other version, and unknown before the plugin reports.

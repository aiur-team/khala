...
The browser harness uses only in-memory fixtures. KHA-153 supplies the live `RoomUiPort`; KHA-132 owns the browser entry point and router; KHA-134 owns live review wiring.
